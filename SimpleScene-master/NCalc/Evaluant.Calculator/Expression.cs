...
namespace NCalc
{
    public class Expression
    {
        ...
        private static Dictionary<string, LogicalExpression> _compiledExpressions = new Dictionary<string, LogicalExpression>();
        ...
        public static bool CacheEnabled
        {
            ...
            { 
                ...
                {
                    // Clears cache
                    _compiledExpressions = new Dictionary<string, LogicalExpression>();
                }
            }
        }
        ...
        public static LogicalExpression Compile(string expression, bool nocache)
        {
            ...
            if (_cacheEnabled && !nocache)
            {
                try
                {
                    ...
                    if (_compiledExpressions.ContainsKey(expression))
                    {
                        ...
                        logicalExpression = _compiledExpressions[expression];
            ...
            if (logicalExpression == null)
            {
                ...
                if (_cacheEnabled && !nocache)
                {
                    ...
                    {
                        Rwl.AcquireWriterLock(Timeout.Infinite);
                        _compiledExpressions[expression] = logicalExpression;
                    }
                    finally
                    {
