...
namespace SimplePaletteQuantizer.Helpers
{
    public class ImageBuffer : IDisposable
    {
        ...
        public Int32 GetBitOffset(Int32 x)
        {
            //============
            //return fastBitX[x];
            return fastBitX[Math.Min(x, fastBitX.Length - 1)];
        }
        ...
        public void ReadPixel(Pixel pixel, Byte[] buffer = null)
        {
            ...
            //var x = Math.Min(pixel.X, fastByteX.Length - 1);
            //var y = Math.Min(pixel.Y, fastByteX.Length - x - 1);
            //Int32 offset = fastByteX[x] + fastY[y];
