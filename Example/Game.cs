...
#region string constants
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            //_mainText = new QFont("Fonts/04992_BladeRunnerMovieFont.ttf", 14, builderConfig);

            //_mainTextOptions = new QFontRenderOptions { DropShadowActive = true, Colour = Color.White, WordSpacing = 0.5f};
            _mainTextOptions = new QFontRenderOptions { DropShadowActive = true, Colour = Color.White, WordSpacing = 0.5f };

            _benchmarkResults = new QFont("Fonts/04991_BladeRunnerMovieFont2.ttf", 14, builderConfig);
